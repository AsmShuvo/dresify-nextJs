...
export default function Home() {
  return (
    <div>
      <main className="bg-[#0B0B21] relative overflow-hidden h-screen">
        <div className="bg-[#0B0B21] flex relative z-20 items-center overflow-hidden">
          <div className="container mx-auto px-6 flex relative py-16">
            <div className="sm:w-2/3 lg:w-2/5 flex flex-col relative z-20">
              ...
              <p className="text-sm mt-2 sm:text-base text-gray-700 dark:text-white">
